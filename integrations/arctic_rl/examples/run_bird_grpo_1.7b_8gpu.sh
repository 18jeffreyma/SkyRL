...
#
# Backend selection: omit ``trainer.override_entrypoint`` for stock SkyRL
# FSDP; set it to ``integrations.arctic_rl.entrypoint`` (below) to dispatch
# into this integration. No PYTHONPATH required — the dotted path resolves
# from the SkyRL repo root.
#
